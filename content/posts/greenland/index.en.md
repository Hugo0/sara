...
We should note that the U.S. form of state was at first organized as a confederation. These are formed when independent states come together voluntarily to achieve some common objectives. In the past, confederations have usually been the predecessors of federal unions. For example, the modern Swiss Confederation, only in its name, was preceded by an association of cantons. 
...
![Polymarket Interface 1](polymarket1.png)

![Polymarket Interface 2](polymarket2.png)
